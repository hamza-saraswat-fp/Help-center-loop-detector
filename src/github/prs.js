...
// "candidate #N" (or "candidate#N", any case, and tolerant of stray spaces
// around the '#' since these show up in freehand PR titles/bodies, e.g.
// "Docs: candidate # 12"). Global and case-insensitive so
// extractCandidateIds can walk every occurrence in one pass.
export const CANDIDATE_REF = /candidate\s*#\s*(\d+)/gi;
