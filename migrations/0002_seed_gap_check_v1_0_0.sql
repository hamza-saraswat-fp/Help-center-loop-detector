-- IAI-660 - Seed the `gap_check` prompt v1.0.0 (Gap check v1).
--
...
--
-- GENERATED from prompts/gap_check_v1_0_0.txt, which is the source of truth. Do not edit
-- the prompt text below by hand. Edit the text file and regenerate, keeping the
-- number this file already has:
--   node scripts/render-prompt-seed.js gap_check 1.0.0 anthropic/claude-sonnet-4.5 'Gap check v1' > migrations/NNNN_seed_gap_check_v1_0_0.sql
--
